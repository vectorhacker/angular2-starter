...
exports.HTTP_BINDINGS = [di_1.bind(http_1.Http).toFactory(function(xhrBackend, requestOptions) {
  return new http_1.Http(xhrBackend, requestOptions);
}, [xhr_backend_1.XHRBackend, base_request_options_1.RequestOptions]), browser_xhr_1.BrowserXhr, di_1.bind(base_request_options_1.RequestOptions).toClass(base_request_options_1.BaseRequestOptions), di_1.bind(base_response_options_1.ResponseOptions).toClass(base_response_options_1.BaseResponseOptions), xhr_backend_1.XHRBackend];
exports.JSONP_BINDINGS = [di_1.bind(http_1.Jsonp).toFactory(function(jsonpBackend, requestOptions) {
  return new http_1.Jsonp(jsonpBackend, requestOptions);
}, [jsonp_backend_1.JSONPBackend, base_request_options_1.RequestOptions]), browser_jsonp_1.BrowserJsonp, di_1.bind(base_request_options_1.RequestOptions).toClass(base_request_options_1.BaseRequestOptions), di_1.bind(base_response_options_1.ResponseOptions).toClass(base_response_options_1.BaseResponseOptions), jsonp_backend_1.JSONPBackend];
