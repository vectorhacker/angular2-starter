...
var selector_1 = require("../core/render/dom/compiler/selector");
...
var TemplateParseVisitor = (function() {
  ...
  TemplateParseVisitor.prototype.visitAttr = function(ast) {
  ...
  TemplateParseVisitor.prototype.visitElement = function(element) {
    ...
    if (nodeName == NG_CONTENT_ELEMENT) {
      ...
      parsedElement = new template_ast_1.EmbeddedTemplateAst(attrs, vars, directives, children, element.sourceInfo);
    } else {
  ...
  TemplateParseVisitor.prototype._parseDirectives = function(selectorMatcher, elementName, matchableAttrs) {
    ...
    var directives = [];
    selectorMatcher.match(cssSelector, function(selector, directive) {
