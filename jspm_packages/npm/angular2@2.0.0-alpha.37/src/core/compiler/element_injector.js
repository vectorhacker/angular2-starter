...
var event_config_1 = require("../render/event_config");
...
var DirectiveBinding = (function(_super) {
  ...
  DirectiveBinding.createFromBinding = function(binding, meta) {
    ...
    var resolvedViewBindings = meta instanceof directives_1.ComponentMetadata && lang_1.isPresent(meta.viewBindings) ? di_1.Injector.resolve(meta.viewBindings) : [];
    var metadata = api_1.RenderDirectiveMetadata.create({
      id: lang_1.stringify(rb.key.token),
      type: meta instanceof directives_1.ComponentMetadata ? api_1.RenderDirectiveMetadata.COMPONENT_TYPE : api_1.RenderDirectiveMetadata.DIRECTIVE_TYPE,
