  ...
  var RenderDirectiveMetadata = (function() {
    function RenderDirectiveMetadata(_a) {
      var id = _a.id,
          ...
          callOnChanges = _a.callOnChanges,
          callDoCheck = _a.callDoCheck,
          callOnInit = _a.callOnInit,
          callAfterContentInit = _a.callAfterContentInit,
          callAfterContentChecked = _a.callAfterContentChecked,
          callAfterViewInit = _a.callAfterViewInit,
          callAfterViewChecked = _a.callAfterViewChecked,
